...
export async function POST(req: Request) {
  try {
    ...
    // Nenhuma alteração validada deve ser gravada sem o envelope AES-256-GCM.
    // Isso evita o antigo comportamento de continuar com Base64 em claro.
    assertEncryptionConfigured();
    ...
    if (error instanceof EncryptionConfigurationError) {
      return NextResponse.json({
        success: false,
        error: 'Cofre bloqueado: configure ENCRYPTION_KEY antes de validar ou alterar registros.',
