                            ...
                            <div className="space-y-4">
                              <div className="flex items-center gap-2">
                                ...
                                <div className="text-left">
                                  <span className="text-[9px] uppercase tracking-wider font-bold text-[#1A1A1A]/40 block">Hash de Integridade</span>
                                  <code className="text-[11px] font-mono text-[#E8490A]">
                                    {item.assinatura_hash || 'Gerado ao validar'}
                                  </code>
                                </div>
                              </div>
                              ...
                              <div className="p-3 bg-white/40 border border-black/07 rounded-xl space-y-1 text-left">
                                <span className="text-[9px] uppercase tracking-wider font-bold text-orange-700 flex items-center gap-1">
                                  <Lock size={10} /> Cofre AES-256-GCM
                                </span>
                                <p className="text-[10px] text-[#1A1A1A]/60 leading-relaxed font-mono">
                                  A chave permanece no servidor; a trilha guarda apenas envelopes cifrados e hashes auditáveis.
                                </p>
                              </div>
                            </div>
                  ...
                  <div>
                    {selectedDnaRelation ? (
                        ...
                        <div className="space-y-4 text-xs">
                          <div>
                            ...
                            <code className="text-[10px] font-mono text-[#E8490A] break-all block p-2 bg-white/40 border border-black/07 rounded-lg mt-1">
                              {selectedDnaRelation.hash_dna || 'Aguardando hash de cruzamento'}
                            </code>
                          </div>

                          <div>
                            <span className="text-[9px] uppercase font-bold text-[#1A1A1A]/40 block">Proteção criptográfica</span>
                            <div className="p-3 bg-white/40 border border-black/07 rounded-xl space-y-1 mt-1 font-mono text-[9px] text-[#1A1A1A]/70">
                              <p><span className="font-bold text-orange-700">ALGORITMO:</span> AES-256-GCM</p>
                              <p><span className="font-bold text-blue-700">INTEGRIDADE:</span> SHA-256 canônico</p>
                              <p className="text-[8px] text-green-700 uppercase font-semibold mt-1 flex items-center gap-1">
                                <CheckCircle size={10} /> Chaves não são exibidas nem exportadas
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="glass-card p-10 border border-black/07 text-center text-xs text-[#1A1A1A]/40 uppercase tracking-widest font-semibold sticky top-28">
                        Selecione uma ligação para inspecionar seu hash de cruzamento e cadeia de auditoria.
                      </div>
                    )}
                  </div>
                </div>
