      ...
      <div className="max-w-[95%] mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-8">
          ...
          <div className="glass-card p-4 text-center">
            ...
            <div className="text-[10px] uppercase tracking-wider text-white/35 font-semibold">Núcleos</div>
          </div>
          <div className="glass-card p-4 text-center">
            <div className="text-2xl font-bold text-green-300">{stats.evidencias}</div>
            <div className="text-[10px] uppercase tracking-wider text-white/35 font-semibold">Evidências</div>
          </div>
          <div className="glass-card p-4 text-center">
            <div className="text-2xl font-bold text-amber-300">{stats.memoria}</div>
            <div className="text-[10px] uppercase tracking-wider text-white/35 font-semibold">Memórias</div>
          </div>
          <div className="glass-card p-4 text-center">
            <div className="text-2xl font-bold text-red-300">{stats.desconhecidos}</div>
            <div className="text-[10px] uppercase tracking-wider text-white/35 font-semibold">Desconhecidos</div>
          </div>
        </div>
        ...
        <div className="glass-card overflow-hidden border border-white/5">
          <table className="w-full text-left text-sm">
            <thead className="bg-black/40 text-[11px] uppercase tracking-wider font-semibold text-white/35 border-b border-white/10">
              <tr>
                <th className="px-6 py-5 font-semibold">Tag / Original</th>
                <th className="px-6 py-5 font-semibold">Obra</th>
                <th className="px-6 py-5 font-semibold">Confiança</th>
                <th className="px-6 py-5 font-semibold">Novidade</th>
                <th className="px-6 py-5 font-semibold">Grupo Temático</th>
                  ...
                  <tr key={tag.id} className="hover:bg-white/5 transition-all group">
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[11px] font-semibold text-blue-400">{Math.round(novidade)}%</span>
                      </div>
                    </td>
                    <td className="px-6 py-5">
                      <span className="px-2 py-1 bg-purple-500/10 border border-purple-500/20 rounded-md text-[11px] font-medium tracking-wider text-purple-300">
          ...
          {tags.length === 0 && (
            <div className="py-20 text-center">
              ...
              <p className="text-white/35 text-sm uppercase tracking-wider font-semibold">Nenhuma contribuição no sistema.</p>
