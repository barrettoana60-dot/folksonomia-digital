  ...
  const defaultNodes: NodeData[] = [
    {
      ...
      subtitle: 'ENTRADA DO CURADOR',
      x: 40,
      y: 50,
      width: 250,
      height: 140,
      inputs: [],
      outputs: [{ id: 'out1', label: 'Texto da Tag' }],
      type: 'prompt',
      status: 'validado',
      content: (
    ...
    },
    {
      ...
      subtitle: 'CLASSIFICADOR DE TOKEN',
      x: 340,
      y: 40,
      width: 280,
      height: 200,
      inputs: [{ id: 'in1', label: 'Texto da Tag' }],
      outputs: [{ id: 'out2', label: 'Rótulo da Entidade' }],
      type: 'engine',
      status: 'validado',
      content: (
        <div className="space-y-2 text-xs">
    ...
    },
    {
      ...
      height: 260,
      inputs: [
        { id: 'in2', label: 'Rótulo da Entidade' },
      ...
      content: (
        <div className="space-y-3 text-xs">
          ...
          <div className="text-[10px] text-white/35 font-mono space-y-1 bg-black/40 p-2 rounded-lg border border-white/5">
            <p>Dimensões de Entrada: 10 | Camadas Ocultas: 8</p>
            <p>Retropropagação: Ativa (Backprop)</p>
            <p>Replay de Memória: Replay Ativo</p>
          </div>
        </div>
      )
    }
