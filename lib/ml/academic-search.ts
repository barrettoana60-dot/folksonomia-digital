...
export const ACADEMIC_CULTURE_CORPUS = [
  ...
  {
    keywords: ['cubismo', 'guernica', 'picasso', 'pablo picasso', 'guerra civil espanhola', 'vanguarda', 'preto e branco', 'dor'],
    titulo: 'Guernica e a Geometria da Dor: O Cubismo Engajado de Pablo Picasso na Guerra Civil Espanhola',
    descricao: 'Investigação histórica e estética sobre a composição monocromática em preto e branco de Guernica, o impacto da Guerra Civil Espanhola e a revolução cubista de Picasso.',
    autores: 'Timothy J. Clark',
    ano: '1993',
    revista: 'Revista de História da Arte e Vanguarda / Museu Reina Sofía',
    link: 'https://www.museoreinasofia.es/coleccion/obra/guernica',
    tipo: 'artigo' as const,
  },
  {
    keywords: ['mestre vitalino', 'vitalino', 'arte popular', 'barro', 'ceramica', 'caruaru', 'alto do moura'],
    titulo: 'Mestre Vitalino e a Escultura Figurativa de Barro: Gênese da Arte Popular do Agreste',
    descricao: 'Estudo monográfico sobre a arte do barro do Alto do Moura em Caruaru, registrando a iconografia cotidiana e a herança de Mestre Vitalino.',
    autores: 'Hermilo Borba Filho',
    ano: '1969',
    revista: 'Cadernos de Cultura Popular — MEC/FUNARTE',
    link: 'https://brasiliana.museus.gov.br',
    tipo: 'livro' as const,
  },
  {
    keywords: ['barroco', 'talha dourada', 'aleijadinho', 'arte sacra', 'colonial', 'escultura', 'ouro preto'],
    titulo: 'O Barroco Mineiro e a Talha Dourada: Morfologia, Sincretismo e Estética da Arte Colonial',
    descricao: 'Análise profunda sobre a talha dourada, o rococó e o barroco sincrético nas igrejas coloniais de Minas Gerais e Bahia.',
    autores: 'Germain Bazin',
    ano: '1971',
    revista: 'Edições Record / Instituto Estadual do Patrimônio Histórico',
    link: 'https://brasiliana.museus.gov.br',
    tipo: 'livro' as const,
  },
  {
    keywords: ['machado', 'machado de assis', 'literatura', 'realismo', 'cultura'],
    titulo: 'Um Mestre na Periferia do Capitalismo: Machado de Assis e as Formas da Ficção',
    descricao: 'Ensaio clássico sobre a sátira, a ironia e a denúncia da ordem escravocrata e patriarcal na obra machadiana.',
    autores: 'Roberto Schwarz',
    ano: '1990',
    revista: 'Editora 34 / Duas Cidades',
    link: 'https://brasiliana.museus.gov.br',
    tipo: 'livro' as const,
  },
];
